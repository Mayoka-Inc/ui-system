...
## Module Focus: UI System

The **UI System** manages the DOM-based HUD, score tracking, and the "Reboot" interface for game restarts.

**Superpowers:**
- Reactive state bindings for real-time score and speed display.
- Flicker-free HUD updates using optimized DOM manipulation.
- Sleek, CSS-based neon styling that matches the synthwave aesthetic.
